//
//  TumblrCreateChatPostViewController.m
//  Tumblr
//
...
#import "TumblrCreateChatPostViewController.h"

#import "TumblrTextField.h"
#import "SSTextView.h"

@implementation TumblrCreateChatPostViewController {
...
- (void)viewDidLoad
{
    ...
    [_bodyField setPlaceholder:@"Tourist: Could you give us directions to Olive Garden?\nNew Yorker: No, but I could give you directions to an actual Italian restaurant."];
...
- (TKPost *)post
{
    ...
    [post setType:[NSNumber numberWithEntityType:TKPostTypeChat]];
